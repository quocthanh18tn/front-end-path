  ...
  <div>
    ...
    <form @submit.prevent="createEvent">
      ...
      <div class="field">
        ...
        :typeable="true"
        @input="$v.event.date.$touch()"/>
      </div>
      <!-- datepicker version 1.6.2 not work with opened event, please using above  -->
      <!-- reference: https://github.com/charliekassel/vuejs-datepicker/issues/625 -->
      <!-- another solution is update datepicker to version 2 -->
      <!-- https://www.npmjs.com/package/@hokify/vuejs-datepicker -->
